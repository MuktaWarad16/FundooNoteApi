...
public class SendCollabModel
{
    ...
    public void SendMessage(string emailId,int notesId, int collaborator)
    {
    ...
    private void MessageQueue_ReceiveCompleted(object sender, ReceiveCompletedEventArgs e)
    {
        try
        {
            ...
            SmtpClient smtpClient = new SmtpClient("smtp.gmail.com")
            {
                Port = 587,
                EnableSsl = true,
                Credentials = new NetworkCredential("poojadonawadi7@gmail.com", "Donawadi@86183"),
            };
            mailMessage.From = new MailAddress("muktaw16@gmail.com");
