...
namespace RepositoryLayer.Services
{
    public class UserRepository :  IUserRepository
    {
        ...
        //        forgotPasswordmodel.EmailId = user.Email;
        //        forgotPasswordmodel.Token = GenerateToken(user.UserId, user.Email);//otp
        ...
        //    else
        //    {
        //        throw new Exception("user doesnt exists for this email");
        //    }
        //}
        ...
        public string ForgetPassword(string Email)
        {
            try
            {
                ...
                if (emailCheck != null)
                {
                    var Token = GenerateToken(emailCheck.UserId, emailCheck.Password);
                    SendMSMQ mSMQmodel = new SendMSMQ();
                    mSMQmodel.SendMessage(Token,Email,emailCheck.FirstName);
